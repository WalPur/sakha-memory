# Generated by Django 5.2 on 2025-05-17 03:43
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('articles', '0009_page_created_at_page_updated_at_alter_page_type'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='page',
            name='tn_parent',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tn_children', to='articles.page', verbose_name='Parent'),
        ),
        migrations.AddField(
            model_name='page',
            name='tn_priority',
